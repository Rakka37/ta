...
# Setelah memanggil fungsi svm_genetic_recommendation()

# Buat list untuk menyimpan nilai kebugaran terbaik dari setiap generasi
fitness_values = []

# Jalankan algoritma genetik dan simpan nilai kebugaran terbaik
for gen in range(1, 41):  # 40 generasi
...
# Plot hasil evolusi nilai kebugaran
plt.figure()
plt.plot(range(1, 41), fitness_values, marker='o')
plt.title('Evolusi Nilai Kebugaran Terbaik')
plt.xlabel('Generasi')
plt.ylabel('Nilai Kebugaran')
plt.grid(True)
plt.tight_layout()
